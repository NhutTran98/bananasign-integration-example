"use strict";(()=>{var L=Object.defineProperty;var x=Object.getOwnPropertySymbols;var F=Object.prototype.hasOwnProperty,S=Object.prototype.propertyIsEnumerable;var H=(i,e,t)=>e in i?L(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t,v=(i,e)=>{for(var t in e||={})F.call(e,t)&&H(i,t,e[t]);if(x)for(var t of x(e))S.call(e,t)&&H(i,t,e[t]);return i};var k=(i,e,t)=>new Promise((o,s)=>{var d=n=>{try{r(t.next(n))}catch(C){s(C)}},c=n=>{try{r(t.throw(n))}catch(C){s(C)}},r=n=>n.done?o(n.value):Promise.resolve(n.value).then(d,c);r((t=t.apply(i,e)).next())});function u(i,e){if(!i[e])throw new Error(`Missing value ${e}`)}var A="https://kratos-auth-staging.luminpdf.com/oauth2/auth";function _(){return(+new Date*Math.random()).toString(36).substring(0,8)}function P(i){return i instanceof DOMException||i.message==="Permission denied"}function U(i,e){let t=window.innerWidth?window.innerWidth:document.documentElement.clientWidth?document.documentElement.clientWidth:screen.width,o=window.innerHeight?window.innerHeight:document.documentElement.clientHeight?document.documentElement.clientHeight:screen.height;return{left:t/2-i/2+window.screenLeft,top:o/2-e/2+window.screenTop}}var y=class{constructor(){this.config={redirect_uri:window.location.href}}initialize(e){u(e,"client_id"),u(e,"scope"),u(e,"response_type"),this.config=v(v({},this.config),e)}signin(e){let{onSuccess:t=()=>{},onError:o=()=>{}}=e,{client_id:s,redirect_uri:d,scope:c,response_type:r,nonce:n=_(),state:C=_()}=this.config,p=new URL(A);p.searchParams.set("client_id",s),p.searchParams.set("redirect_uri",d),p.searchParams.set("scope",c),p.searchParams.set("response_type",r),p.searchParams.set("nonce",n),p.searchParams.set("state",C);let{left:l,top:a}=U(700,700),g="width=".concat("700",",height=").concat("700",",left=").concat(l.toString(),",top=").concat(a.toString(),",resizable=no,location=no,menubar=no"),h=window.open(p,"LuminAuthentication",g);if(!h)throw new Error("We were unable to open the new tab, its likely that the request was blocked.");let w=setInterval(()=>{try{h.closed&&(clearInterval(w),o({error:"tab_closed",error_description:"The user closed the tab before authentication could be completed"}));let{location:m}=h;if(m.href&&m.href.indexOf(d)!==0)return;clearInterval(w);let f=new URLSearchParams(m.hash.substring(1));h.close(),t({code:f.get("code"),access_token:f.get("access_token"),id_token:f.get("id_token"),error:f.get("error"),error_description:f.get("error_description")})}catch(m){if(P(m))return;o({error:"auth_error",error_description:m.message}),h.closed||h.close(),clearInterval(w)}},300)}},M=new y;var T="https://app-auth-staging.bananasign.co/api/web/v1/document-signing",E="https://app-auth-staging.bananasign.co";var b=class{sendAndSign(e){u(e,"accessToken"),u(e,"fileData"),u(e,"fileName");let{accessToken:t,fileData:o,fileName:s,onError:d=()=>{},onLoading:c=()=>{}}=e;c(!0),fetch(`${T}/init`,{method:"POST",body:JSON.stringify({fileName:s}),headers:{Authorization:`Bearer ${t}`,"Content-Type":"application/json"}}).then(r=>k(this,null,function*(){let n=yield r.json();if(n.error){d({error:n.error,message:n.message});return}if(n.flowId){let C=typeof o=="function"?yield o():o;yield fetch(n.preSignedUrl,{method:"PUT",body:C,headers:{"Content-Type":"application/pdf"}});let p=g=>{if(g.origin===E&&["close_task","back_step"].includes(g.data.type)){let h=document.getElementById("bananaSignIframeWrapper");h==null||h.remove(),window.removeEventListener("message",p,!1)}};window.addEventListener("message",p,!1);let l=document.createElement("div");l.style.position="absolute",l.style.top="0",l.style.zIndex="99",l.style.display="flex",l.style.justifyContent="center",l.style.alignItems="center",l.style.width="100%",l.style.height="100%",l.id="bananaSignIframeWrapper";let a=document.createElement("iframe");a.style.width="100%",a.style.width="100%",a.style.height="100%",a.src=`${E}/embed/${n.flowId}?token=${t}&type=default&owner=${JSON.stringify(n.owner)}`,a.title="Iframe Upload",a.allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture",a.id="bananaSignIframe",a.onload=()=>{c(!1)},a.style.visibility="visible",a.allowFullscreen=!0,l.appendChild(a),document.body.appendChild(l)}})).catch(r=>{throw r})}},V=class extends HTMLElement{connectedCallback(){let e=this.getAttribute("size")||"large",t=this.attachShadow({mode:"closed"}),o=document.createElement("style"),s=document.createElement("div");switch(s.setAttribute("class","container"),e){case"small":o.textContent=`
          .container {
            position: relative;
            border-radius: 4px;
        ...
        `,s.appendChild(d);break;case"large":{o.textContent=`
        .container {
          position: relative;
          border-radius: 8px;
          border: 1px solid #BDD8FF;
      ...
      </svg>`,r.appendChild(n),s.appendChild(c),s.appendChild(r)}break;default:break}t==null||t.appendChild(o),t==null||t.appendChild(s)}};customElements.define("lumin-sign",V);var Z=new b;window.lumin={auth:M,sign:Z};})();
